...
\begin{cventries}
  ...
  {Spine Animation Library for Raylib Game Engine} % Organization
  ...
  \end{cvitems}
   ...
   \cventry
  {C99/Webassembly Developer - Maintainer} % Job title
  {Dear ImGUI implementation for Raylib Game Engine} % Organization
  {Prague, Czech Republic} % Location
  ...
  \end{cvitems}
   ...
   \cventry
    {AVP Angular Developer} % Job title
    ...
    {Inaka(an Erlang Solutions Company)} % Organization
    {Buenos Aires, Argentina} % Location
